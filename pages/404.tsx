const NotFound = () => {
    return (
        <div className="container flex justify-center content-center flex-col bg-cream dark:bg-wood max-w-md rounded-lg">
            <h1 className="text-wood dark:text-cream text-center text-5xl uppercase mb-3 p-5 font-adventProHeader">
                Page Not Found
            </h1>
            <hr className="bg-wood dark:bg-cream my-auto mx-10 p-1 rounded-lg border-wood dark:border-l-cream" />
